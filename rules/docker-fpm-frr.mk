...
$(DOCKER_FPM_FRR)_DEPENDS += $(FRR) $(FRR_PYTHONTOOLS) $(SWSS) $(LIBYANG3)
...
$(DOCKER_FPM_FRR)_LOAD_DOCKERS += $(DOCKER_SWSS_LAYER_TRIXIE)
...
SONIC_TRIXIE_DOCKERS += $(DOCKER_FPM_FRR)
SONIC_TRIXIE_DBG_DOCKERS += $(DOCKER_FPM_FRR_DBG)
